cd ../../
#python3 run_downstream.py -m train  -u avhubert_large_lrs3  -d audioset -s fusion_feats --pooled_features_path /work/u7196393/pooled_features -p /work/u7196393/result/avhubert_large_connector_mean_linear_-3/ -o "config.optimizer.lr=1.0e-3"
