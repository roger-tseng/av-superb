...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, upstream_rate, downstream_expert, expdir, **kwargs):
        ...
        self.train_dataset = AudiosetDataset("audioset_train.csv","/work/u3933430/testAudioset",**self.datarc)
        self.dev_dataset = AudiosetDataset("audioset_dev.csv","/work/u3933430/testAudioset",**self.datarc)
        self.test_dataset = AudiosetDataset("audioset_test.csv","/work/u3933430/testAudioset",**self.datarc)
