...
def init_distributed_mode(args):
    if args.dist_on_itp:
        ...
        print(
            f"Environment variable initialization: RANK={os.environ['RANK']} WORLD_SIZE={os.environ['WORLD_SIZE']}, LOCAL_RANK={os.environ['LOCAL_RANK']}"
        )
...
def merge_mae_avmae(avmae_ckpt, mae_ckpt):
    ...
    new_weight = (
        mae_ckpt_model["patch_embed.proj.weight"].unsqueeze(2).repeat(1, 1, 2, 1, 1)
    )
    ...
    avmae_ckpt_model["patch_embed_v.proj.bias"] = mae_ckpt_model[
...
block_v_list = [
    "blocks_v.11.norm1.weight",
    "blocks_v.11.norm1.bias",
    "blocks_v.11.attn.qkv.weight",
    "blocks_v.11.attn.qkv.bias",
    "blocks_v.11.attn.proj.weight",
    "blocks_v.11.attn.proj.bias",
    "blocks_v.11.norm2.weight",
    "blocks_v.11.norm2.bias",
    "blocks_v.11.mlp.fc1.weight",
    "blocks_v.11.mlp.fc1.bias",
    "blocks_v.11.mlp.fc2.weight",
    "blocks_v.11.mlp.fc2.bias",
]

block_v_list_large = [
    "blocks_v.23.norm1.weight",
    "blocks_v.23.norm1.bias",
    "blocks_v.23.attn.qkv.weight",
    "blocks_v.23.attn.qkv.bias",
    "blocks_v.23.attn.proj.weight",
    "blocks_v.23.attn.proj.bias",
    "blocks_v.23.norm2.weight",
    "blocks_v.23.norm2.bias",
    "blocks_v.23.mlp.fc1.weight",
    "blocks_v.23.mlp.fc1.bias",
    "blocks_v.23.mlp.fc2.weight",
    "blocks_v.23.mlp.fc2.bias",
]
