...
class BasicTransform(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            temp_kernel_size (int): the temporal kernel size of the middle
                convolution in the ResBlock.
    ...
    def __init__(
        ...
        Args:
            ...
            temp_kernel_sizes (list): list of the p temporal kernel sizes of the
                convolution in the ResBlock. Different temp_kernel_sizes
                control different pathways.
            stride (list): list of the p strides of the ResBlock. Different
                stride control different pathways.
