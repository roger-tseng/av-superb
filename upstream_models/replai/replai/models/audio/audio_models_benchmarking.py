...
class Cnn6(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Cnn6_mAP_0.343.pth"
            ...
            self.load_state_dict(torch.load(ckpt_fn, map_location="cpu"))
    ...
    def load_state_dict(self, state_dict, strict: bool = True):
        for k in state_dict:
            if (
                "spectrogram_extractor" in k
                or "logmel_extractor" in k
                or "spec_augmenter" in k
                or "bn0" in k
            ):
                del state_dict[k]
...
class Cnn10(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Cnn10_mAP_0.380.pth"
...
class Cnn14(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Cnn14_mAP_0.431.pth"
...
class ResNet22(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/ResNet22_mAP_0.430.pth"
...
class ResNet38(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/ResNet38_mAP_0.434.pth"
...
class ResNet54(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/ResNet54_mAP_0.429.pth"
...
class MobileNetV1(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/MobileNetV1_mAP_0.389.pth"
...
class MobileNetV2(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/MobileNetV2_mAP_0.383.pth"
...
class Res1dNet31(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Res1dNet31_mAP_0.365.pth"
            url = "https://zenodo.org/record/3987831/files/Res1dNet31_mAP%3D0.365.pth"
            if not os.path.isfile(ckpt_fn):
                os.makedirs(os.path.dirname(ckpt_fn), exist_ok=True)
                urllib.request.urlretrieve(url, ckpt_fn)
            self.load_state_dict(torch.load(ckpt_fn, map_location="cpu"))
...
class Res1dNet51(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Res1dNet51_mAP_0.355.pth"
            url = "https://zenodo.org/record/3987831/files/Res1dNet51_mAP%3D0.355.pth"
            if not os.path.isfile(ckpt_fn):
                os.makedirs(os.path.dirname(ckpt_fn), exist_ok=True)
                urllib.request.urlretrieve(url, ckpt_fn)
            self.load_state_dict(torch.load(ckpt_fn, map_location="cpu"))
...
class Wavegram_Cnn14(nn.Module):
    def __init__(self, classes_num=527, pretrained=False):
        ...
        if pretrained:
            ...
            ckpt_fn = (
                "models/pretrained/audio_benchmarking/Wavegram_Cnn14_mAP_0.389.pth"
            )
            url = (
                "https://zenodo.org/record/3987831/files/Wavegram_Cnn14_mAP%3D0.389.pth"
            )
            if not os.path.isfile(ckpt_fn):
                os.makedirs(os.path.dirname(ckpt_fn), exist_ok=True)
                urllib.request.urlretrieve(url, ckpt_fn)
...
class Wavegram_Logmel_Cnn14(nn.Module):
    def __init__(self, classes_num=527, pretrained=True):
        ...
        if pretrained:
            ...
            ckpt_fn = "models/pretrained/audio_benchmarking/Wavegram_Logmel_Cnn14_mAP_0.439.pth"
            url = "https://zenodo.org/record/3987831/files/Wavegram_Logmel_Cnn14_mAP%3D0.439.pth"
            if not os.path.isfile(ckpt_fn):
                os.makedirs(os.path.dirname(ckpt_fn), exist_ok=True)
                urllib.request.urlretrieve(url, ckpt_fn)
            self.load_state_dict(torch.load(ckpt_fn, map_location="cpu"))
